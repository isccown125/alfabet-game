...
export class GameAnswers {
    ...
    createAnswerButton(label, id) {
        return new Component().create('button').setClassList('level-button').setTextContext(label).setAttributes({ name: 'data-answer', value: id }).htmlElement
    }
    ...
    createActionsComponent() {
        this.actionComponent = new Component().create('div').setId('choose-answer').htmlElement
